<template>
    <header class="flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
        <nav class="[--placement:bottom-right] mt-6 relative max-w-7xl w-full bg-white border border-gray-200 rounded-[36px] mx-2 py-3 px-4 md:flex md:items-center md:justify-between md:py-0 md:px-6 lg:px-8 xl:mx-auto dark:bg-gray-800 dark:border-gray-700"
            aria-label="Global">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white" href="#" aria-label="Brand">NetGrid</a>
                <div class="md:hidden">
                    <button type="button"
                ...
                <div
                    ...
                    <div
                        ...
                        <button type="button"
                            ...
                            {{ user.name }}
                            <svg class="w-4 h-4 ml-2" xmlns="http://www.w3.org/2000/svg" width="16" height="16"
