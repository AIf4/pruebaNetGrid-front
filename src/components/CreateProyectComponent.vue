     ...
     <div class="mx-auto my-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 ">
        ...
        <form action="" class="mx-auto mb-0 mt-8 max-w-md space-y-4" @submit.prevent="createUser">
            <div>
                ...
                <div class="relative">
                    <input type="text" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                        placeholder="Titulo del proyecto" v-model="title" />

                    <span class="absolute inset-y-0 end-0 grid place-content-center px-4">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="none"
                            class="h-4 w-4 text-gray-400" viewBox="0 0 16 16" stroke="currentColor">
            ...
            <div>
                ...
                <div class="relative">
                    <input type="text" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                        placeholder="Ingresa una descripcion" v-model="description" />
            ...
            <div>
                ...
                <div class="relative">
                    <input type="date" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                        placeholder="fecha inicio" v-model="start_date" />
            ...
            <div>
                ...
                <div class="relative">
                    <input type="date" class="w-full rounded-lg border-gray-200 p-4 pe-12 text-sm shadow-sm"
                        placeholder="fecha final" v-model="end_date" />
...
export default defineComponent({
    ...
    methods: {
        async createUser() {
            try {
                await axios.post('http://127.0.0.1:8000/api/proyect', {
                    "title": this.title,
